...
function Blog() {
  ...
  useEffect(() => {
    ...
    line.addEventListener("touchend", (e) => handleTouchEnd(e, body_))
    ...
    line.addEventListener("touchend", (e) => handleTouchEnd(e,container_))
    ...
    line.addEventListener("touchend", (e) => handleTouchEnd(e,square_))
