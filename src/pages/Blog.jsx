...
function Blog() {
  ...
  useEffect(() => {
    ...
    line.addEventListener("touchend", () => handleTouch(body_))
    ...
    line.addEventListener("touchend", () => handleTouch(container_))
    ...
    line.addEventListener("touchend", () => handleTouch(square_))
